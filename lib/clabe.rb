module Clabe
  ClabeValidation = Struct.new(:is_valid?, :bank_tag, :bank_name, :bank_code, :city, :cities, :errors)
  ...
  CITIES = {
    ...
    '027' => ['Tecate MX-BCN', 'Tijuana'],
    '028' => ['La Mesa', 'Playas de Rosarito MX-BCN', 'Tijuana'],
    '040' => ['La Paz MX-BCS'],
    ...
    '060' => ['Gómez Palacio', 'Torreón MX-COA'],
    '061' => ['Abasolo MX-COA'],
    '062' => ['Acuña MX-COA', 'Ciudad Acuña'],
    '063' => ['Allende MX-COA'],
    ...
    '070' => ['Muzquiz MX-COA'],
    '071' => ['Nava MX-COA'],
    '072' => ['Nueva Rosita', 'Nva Rosita MX-COA'],
    '073' => ['Palau MX-COA'],
    ...
    '100' => ['Terán', 'Tuxtla Gutiérrez MX-CHP'],
    ...
    '109' => ['Comitán de Dominguez MX-CHP', 'Villa Las Rosas'],
    ...
    '138' => ['Villa Corzo MX-CHP', 'Villa Flores'],
    '140' => ['Yajalón MX-CHP'],
    '150' => ['Chihuahua MX-CHH', 'Ciudad Delicias'],
    '151' => ['Ahumada MX-CHH'],
    '152' => ['Anahuac MX-CHH', 'Ciudad Anáhuac'],
    '153' => ['Ascension MX-CHH'],
    '154' => ['Buenaventura MX-CHH'],
    '155' => ['Camargo MX-CHH', 'Ciudad Camargo'],
    '156' => ['Casas Grandes MX-CHH'],
    '157' => ['Creel MX-CHH'],
    '158' => ['Ciudad Cuauhtémoc', 'Cuauhtemoc MX-CHH'],
    '159' => ['Gomez Farias MX-CHH'],
    '160' => ['Guachochi MX-CHH'],
    '161' => ['Ciudad Guerrero', 'Guerrero MX-CHH'],
    '162' => ['Hidalgo del Parral MX-CHH', 'Parral'],
    '163' => ['Ciudad Jiménez MX-CHH'],
    '164' => ['Ciudad Juárez MX-CHH'],
    '165' => ['Ciudad Madera', 'Madera MX-CHH'],
    '166' => ['Meoqui MX-CHH'],
    '167' => ['El Molino de Namiquipa', 'Namiquipa MX-CHH'],
    '168' => ['Nuevo Casas Grandes', 'Nvo Casas Grandes MX-CHH'],
    '169' => ['Ojinaga MX-CHH'],
    '170' => ['Praxedis G. Guerrero MX-CHH'],
    '171' => ['Puerto Palomas MX-CHH'],
    '172' => ['Santa Barbara MX-CHH'],
    '173' => ['Saucillo MX-CHH'],
    '180' => ['Atizapan', 'Chalco','Ciudad de México MX-CMX', 'Coacalco', 'Cuautitlán Izcalli', 'Ecatepec', 'Huehuetoca', 'Huixquilucan', 'Ixtapaluca', 'Los Reyes la Paz', 'Naucalpan', 'Nezahualcóyotl', 'Tecamac', 'Teotihuacán', 'Texcoco', 'Tlalnepantla'],
    '190' => ['Durango MX-DUR'],
    '191' => ['Canatlan MX-DUR'],
    '192' => ['Cuencame MX-DUR'],
    '193' => ['El Salto MX-DUR'],
    ...
    '237' => ['Purísima de Bustos', 'San Francisco del Rincoón MX-GUA'],
    ...
    '271' => ['Huitzuco MX-GRO'],
    '272' => ['Iguala MX-GRO', 'La Sabana'],
    '273' => ['Olinala MX-GRO'],
    '274' => ['Cuajinicuilapa', 'Ometepec MX-GRO'],
    ...
    '294' => ['Ciudad Sahagún MX-HID', 'Teocaltiche'],
    ...
    '314' => ['Zimapán MX-HID'],
    '320' => ['El Salto MX-JAL', 'Guadalajara', 'San Pedro Tlaquepaque', 'Tlajomulco', 'Tonala', 'Zapopan'],
    '321' => ['Acatic MX-JAL'],
    ...
    '331' => ['Atequiza', 'Atotonilquillo MX-JAL'],
    '332' => ['Atoyac MX-JAL'],
    '333' => ['Autlán de Navarro MX-JAL'],
    '334' => ['Ayotlan MX-JAL', 'Azteca'],
    '335' => ['Ayutla MX-JAL'],
    ...
    '375' => ['Las Juntas', 'Nuevo Vallarta', 'Pitillal', 'Puerto Vallarta MX-JAL'],
    ...
    '437' => ['Chimalhuacan MX-MEX', 'La Paz (Reyes Acaq.) MX-MEX'],
    '438' => ['Lerma MX-MEX'],
    '439' => ['Luvianos MX-MEX'],
    ...
    '451' => ['Tenago del Valle', 'Tenango de Arista MX-MEX'],
    '452' => ['Texcaltitlan MX-MEX'],
    '453' => ['Santiago Tiangistenco', 'Tianguistenco MX-MEX'],
    '454' => ['Tonatico MX-MEX'],
    '455' => ['Tultepec MX-MEX'],
    ...
    '501' => ['Nueva Italia', 'Nva Italia de Ruiz MX-MIC'],
    ...
    '542' => ['Cuautla MX-MOR', 'Oaxtepec, Morelos'],
    '543' => ['Jiutepec MX-MOR'],
    '544' => ['Jojutla MX-MOR'],
    ...
    '577' => ['Xalisco MX-NAY'],
    '580' => ['Apodaca MX-NLE', 'Cadereyta', 'Ciudad Guadalupe', 'General Escobedo', 'Monterrey', 'San Nicolás de los Garza', 'San Pedro Garza García', 'Santa Catarina'],
    '581' => ['Abasolo MX-NLE'],
    ...
    '601' => ['El Cercado', 'Santiago MX-NLE', 'Villa de Santiago'],
    '610' => ['Oaxaca MX-OAX'],
    '611' => ['Asuncion Nochixtlan MX-OAX'],
    '612' => ['Guelatao MX-OAX'],
    '613' => ['Heroica Cd de Tlaxiaco MX-OAX', 'Tlaxiaco'],
    ...
    '627' => ['Lagunas', 'San Andres Lagunas MX-OAX', 'San Juan Bautista T. MX-OAX', 'Tuxtepec'],
    '629' => ['San Pedro Mixtepec MX-OAX'],
    '630' => ['Pochutla', 'San Pedro Pochutla MX-OAX'],
    '631' => ['San Pedro Tapanatepec MX-OAX'],
    '632' => ['Santa Lucía del Camino MX-OAX'],
    '633' => ['Santa Maria del Tule MX-OAX'],
    '634' => ['Bahías de Huatulco', 'Santa Maria Huatulco MX-OAX'],
    '635' => ['Santiago Juxtlahuaca MX-OAX'],
    '636' => ['Pinotepa Nacional', 'Santiago Pinotepa Nal MX-OAX'],
    '637' => ['Sto Domingo Tehuantepec MX-OAX', 'Tehuantepec'],
    '638' => ['Tlacolula D Matamoros MX-OAX'],
    '639' => ['Villa de Tamazulapam MX-OAX'],
    '640' => ['Zimatlán MX-OAX'],
    '650' => ['Cholula', 'Cuautlancingo MX-PUE', 'La Resurrección', 'Puebla', 'San Baltazar Campeche'],
    '651' => ['Acatlan MX-PUE'],
    '652' => ['Acatzingo MX-PUE'],
    '653' => ['Amozoc MX-PUE'],
    '654' => ['Atlixco MX-PUE'],
    '655' => ['Ciudad Serdan MX-PUE', 'Los Heroes de Puebla MX-PUE'],
    ...
    '668' => ['San Felipe Hueyotlipan', 'Sto Tomas Hueyotlipan MX-PUE'],
    '669' => ['Tecamachalco MX-PUE'],
    '670' => ['Tehuacán MX-PUE'],
    '671' => ['San Lorenzo', 'Tepeaca MX-PUE'],
    '672' => ['Teziutlán MX-PUE'],
    '673' => ['Tlatlauquitepec MX-PUE'],
    '674' => ['Xicotepec de Juárez MX-PUE'],
    '675' => ['Zacapoaxtla MX-PUE'],
    '676' => ['Zacatlán MX-PUE'],
    '680' => ['El Pueblito Correg. MX-QUE', 'Pedro Escobedo', 'Querétaro', 'Villa Corregidora'],
    '681' => ['Amealco MX-QUE'],
    ...
    '690' => ['Chetumal MX-ROO'],
    '691' => ['Cancún MX-ROO', 'Col. Puerto Juárez'],
    '692' => ['Cozumel MX-ROO'],
    ...
    '743' => ['Los Mochis MX-SIN', 'Topolobampo'],
    '744' => ['Mazatlán MX-SIN'],
    '745' => ['Mocorito MX-SIN'],
    '746' => ['Navolato MX-SIN'],
    '747' => ['Quila MX-SIN'],
    ...
    '765' => ['Caborca MX-SON'],
    '766' => ['Cananea MX-SON'],
    '767' => ['Ciudad Obregón MX-SON', 'Esperanza'],
    '768' => ['Cumpas MX-SON'],
    '769' => ['Empalme MX-SON'],
    '770' => ['Guaymas MX-SON', 'San Carlos'],
    ...
    '790' => ['Tamulte', 'Villa Hermosa MX-TAB'],
    '791' => ['Balancan MX-TAB'],
    '792' => ['Cárdenas', 'Cardenas MX-TAB'],
    ...
    '811' => ['Altamira MX-TAM'],
    '812' => ['Camargo MX-TAM'],
    '813' => ['Ciudad Madero MX-TAM', 'Tampico'],
    ...
    '821' => ['Colombia', 'Nuevo Laredo MX-TAM'],
    '822' => ['Hidalgo MX-TAM', 'Reynosa'],
    ...
    '872' => ['La Antigua MX-VER', 'Villa José Cardel'],
    '873' => ['Las Choapas MX-VER'],
    '874' => ['Lerdo de Tejada MX-VER'],
    '875' => ['Los Naranjos MX-VER', 'Naranjos'],
    ...
    '893' => ['Tamiahua MX-VER'],
    '894' => ['Platón Sánchez', 'Tantoyuca MX-VER'],
    ...
    '903' => ['Túxpam de Rodríguez Cano', 'Tuxpan MX-VER'],
    '904' => ['Vega de Alatorre MX-VER'],
    '905' => ['Ciudad Industrial Framboyan', 'Veracruz MX-VER'],
    '906' => ['Xico MX-VER'],
    '910' => ['Mérida MX-YUC'],
    '911' => ['Izamal MX-YUC'],
    '912' => ['Maxcanu MX-YUC'],
    ...
    '915' => ['Progreso', 'Puerto Progreso MX-YUC'],
    '916' => ['Tekax MX-YUC'],
    '917' => ['Ticul MX-YUC'],
    '918' => ['Tizimín MX-YUC'],
    '919' => ['Uman MX-YUC'],
    ...
    '974' => ['Crédito Automotriz', 'Crédito personal'],
  ...
  def self.validate(clabe)
    ...
    clabe_validation[:errors] << 'invalid length' unless clabe.length == 18
    clabe_validation[:errors] << 'invalid characters' unless (clabe =~ /[^0-9]/).nil?
    clabe_validation[:errors] << 'invalid bank' if clabe_params[:bank].nil?
    clabe_validation[:errors] << 'invalid city' if clabe_params[:city].nil?

    unless clabe_params[:checksum] == clabe_params[:real_checksum]
      clabe_validation[:errors] << 'must have a valid control digit'
    end

    return clabe_validation unless clabe_validation.errors.empty?
    ...
    clabe_validation[:cities] = clabe_params[:cities]
    clabe_validation
  end
end
